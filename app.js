...
function initAudioPlayer() {
    ...
    function updateAudioStateUI() {
        const isMutedOrPaused = audioEl.muted || audioEl.paused;
        if (toggleBtn) {
            if (isMutedOrPaused) {
                ...
                if (equalizerEl) equalizerEl.classList.add("is-muted");
            } else {
                ...
                if (equalizerEl) equalizerEl.classList.remove("is-muted");
            }
        }
    }
    ...
    if (toggleBtn) {
        toggleBtn.addEventListener("click", () => {
            if (audioEl.paused) {
                audioEl.muted = false;
                audioEl.play().then(updateAudioStateUI).catch(e => console.log(e));
            } else {
