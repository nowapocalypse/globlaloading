...
const CONFIG = {
    ...
    music: {
        ...
        shuffle: true,          // Şarkıları rastgele çalsın mı? (true/false)
        ...
        playlist: [
            {
                ...
                artist: "t.A.T.u.",
                src: "music/All-The-Things-She-Said.mp3"
            },
            {
                title: "Sugar, We're Goin Down",
                artist: "Fall Out Boy",
                src: "music/Fall Out Boy - Sugar, Were Goin Down (Audio).mp3"
            }
        ]
    },
    ...
    links: {
        ...
        steamGroup: "https://steamcommunity.com/groups/globladarkrp",
